...
#define _DUTY_MAX 1884 // 2000
#define _DUTY_NEU 1550 // 1500
#define _DUTY_MIN 1084 // 1000

#define _SERVO_ANGLE_DIFF  74  // Replace with |D - E| degree
#define _SERVO_SPEED       100  // servo speed

#define _BANGBANG_RANGE    384  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return 596 + -1.92*a_value + 1.56E-03 * a_value * a_value;
}
